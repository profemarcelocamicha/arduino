...
void loop() {
  ...
  if (red_light > green_light && red_light > blue_light) {
    Serial.println("Color predominante: ROJO");
  } else if (green_light > red_light && green_light > blue_light) {
    Serial.println("Color predominante: VERDE");
  } else if (blue_light > red_light && blue_light > green_light) {
    Serial.println("Color predominante: AZUL");
  } else {
    Serial.println("Color indeterminado o equilibrado");
  }
